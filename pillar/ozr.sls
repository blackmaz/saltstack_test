...
application:
  ...
  datasource_url: jdbc:mysql://localhost:3306/nest_dev


tomcat:
  tomcat_insthome: /www/nest_dev
  tomcat_dir: tomcat7
  tomcat_home: /www/nest_dev/tomcat7
  tomcat_version: apache-tomcat-7.0.75
  tomcat_downloadurl: http://apache.mirror.cdnetworks.com/tomcat/tomcat-7/v7.0.75/bin/apache-tomcat-7.0.75
