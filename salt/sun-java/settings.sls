...
{%- set default_version_name = 'jdk1.8.0_111' %}
{%- set default_prefix       = '/opt/java' %}
{%- set default_source_url   = 'http://download.oracle.com/otn-pub/java/jdk/8u111-b14/jdk-8u111-linux-x64.tar.gz' %}
{%- set default_source_hash  = '187eda2235f812ddb35c352b5f9aa6c5b184d611c2c9d0393afb8031d8198974' %}
